...
class KernelBuilder:
    ...
    def build_kernel(self, forest_height, n_nodes, batch_size, rounds):
        ...
        NUM_OFFLOAD = 4
        # We need tmp_madd for the groups we offload (g >= 32 - NUM_OFFLOAD)
        tmp_madd = {}
        for g in range(32 - NUM_OFFLOAD, 32):
            tmp_madd[g] = [self.alloc_scratch(f"tmp_madd_{g}_{i}") for i in range(8)]
